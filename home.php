            ...
            <nav class="navbar navbar-expand-lg bg-body-secondary bg-opacity-25 position-fixed" id="navigation">
                <div class="container-fluid d-flex justify-content-between">
                    <div class="p-2">
                        ...
                        <a class="navbar-brand" href="#">Korphanage</a>
        ...
        <div class="row justify-content-md-center">
            <div class="col-md-8">
                <div class="d-flex px-5 bg-body flex-column justify-content-center align-items-center vh-100">
                    <h1 class="mb-3 font-monospace">H O M E</h1>
                    <p class="fs-3 fw-light text-center">This webite was made for <a class="link-underline-dark link-underline-opacity-25 link-offset-2 link-secondary" href="#">Korphanage</a>, here you'll can insert, update, delete and watch all data of each child!</p>
                    <div class="row w-100 d-flex justify-content-center">
                        <div class="d-flex justify-content-center flex-wrap align-items-center w-100">
                            <div class="p-1">
                                <a class="btn btn-dark p-2" href="./pages/new-child.php">Add New Children</a>
                            </div>
                            <div class="p-1">
